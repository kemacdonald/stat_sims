...
## Statistical intuition pumps

Using the basic tools that we have added to our simulation toolkit, we can start writing code to improve our statistical intuitions. 
...
ggplot(aes(x = .), data = t_sims_null) + 
  geom_line(stat = "density", size = 1, color = "darkorange") +
  geom_vline(xintercept = our_t, linetype = "dashed")
```
...
ggplot(aes(x = .), data = t_sims_null) + 
  geom_line(stat = "density", size = 1, color = "darkorange") +
  geom_vline(xintercept = our_t, linetype = "dashed", color = "darkred", size = 1) +
